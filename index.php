...
<body>
        ...
        <div class="container"> <a class="navbar-brand navbar-logo" href="#"> <img src="img/sirevoLogo.png" alt="logo" class="logo-1"> </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="insertData.php" data-scroll-nav="7">Tambah Data VCD</a> </li>
                    ...
                    <li class="nav-item"> <a class="nav-link" href="logout.php" data-scroll-nav="5">Logout</a> </li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <section class="member-registration section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="sectioner-header text-center">
                        ...
                        <span class="line"></span>
                        <p>Register as a member by filling out the form below:</p>
                    </div>
                    <div class="section-content">
                        <form id="member_registration_form" action="process_registration.php" method="post">
                            <div class="row">
                                <div class="col">
                                    <input type="text" id="full_name" class="form-input w-100" name="full_name" placeholder="Full Name" required>
                                </div>
                                <div class="col">
                                    <input type="date" id="birthdate" class="form-input w-100" name="birthdate" placeholder="Birthdate" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <input type="text" id="address" class="form-input w-100" name="address" placeholder="Address" required>
                                </div>
                                <div class="col">
                                    <input type="text" id="id_number" class="form-input w-100" name="id_number" placeholder="ID Number" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <select id="gender" class="form-input w-100" name="gender" required>
                                        <option value="male">Male</option>
                                        <option value="female">Female</option>
                                    </select>
                                </div>
                                <div class="col">
                                    <input type="text" id="contact_info" class="form-input w-100" name="contact_info" placeholder="Contact Information" required>
                                </div>
                            </div>
                            <button class="btn-grad w-100 text-uppercase" type="submit" name="register_button">Register</button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <!-- Peminjaman Section -->
    <section class="peminjaman section-padding" data-scroll-index='7'>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="sectioner-header text-center">
                        <h3>Peminjaman VCD</h3>
                        <span class="line"></span>
                        <p>Silakan mengisi formulir peminjaman VCD di bawah ini:</p>
                    </div>
                    <div class="section-content">
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-8">
                                <form id="peminjaman_form" action="proses_peminjaman.php" method="post">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="text" id="kode_anggota" class="form-input w-100" name="kode_anggota" placeholder="Kode Anggota" required>
                                        </div>
                                        <div class="col-md-6">
                                            <input type="text" id="kode_vcd" class="form-input w-100" name="kode_vcd" placeholder="Kode VCD" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="text" id="tanggal_sewa" class="form-input w-100" name="tanggal_sewa" placeholder="Tanggal Sewa" onfocus="(this.type='date')" onblur="(this.type='text')" required>
                                        </div>
                                        <div class="col-md-6">
                                            <input type="text" id="tarif_sewa" class="form-input w-100" name="tarif_sewa" placeholder="Tarif Sewa" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="text" id="tanggal_pengembalian" class="form-input w-100" name="tanggal_pengembalian" placeholder="Tanggal Pengembalian" onfocus="(this.type='date')" onblur="(this.type='text')" required>
                                        </div>
                                    </div>
                                    <button class="btn-grad w-100 text-uppercase" type="submit" name="button">Submit Peminjaman</button>
                                    <a href="dataPeminjam.php">LihatData</a>
                                </form>
                            </div>
                        </div>
                    </div>
